...
describe UsersController do
  ...
  context "with manager logged in" do
    ...
    def valid_attributes
      attrs = FactoryGirl.build(:user, account: account).attributes.slice("username", "email", "first_name", "last_name", "role")
      attrs.merge!(:password => "123123", :password_confirmation => "123123")
    end
    ...
    describe "DELETE destroy" do
      it "destroys the requested user" do
        user = account.users.create! valid_attributes
        expect {
