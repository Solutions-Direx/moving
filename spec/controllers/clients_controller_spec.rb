...
describe ClientsController do
  ...
  context "with manager logged in" do
    ...
    let(:client) { FactoryGirl.create(:client, :account => account) }
    ...
    def valid_attributes
      FactoryGirl.build(:client, :account => account).attributes.slice("name", "phone1", "phone2", "email")
    end
    ...
    describe "DELETE destroy" do
      it "destroys the requested client" do
        client = account.clients.create! valid_attributes
        expect {
