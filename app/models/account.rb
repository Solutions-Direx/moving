class Account < ActiveRecord::Base
  ...
  attr_accessible :franchise_cancellation_amount, :companies_attributes,
                  ...
                  :accounting_moving_account_number, :accounting_tip_account_number, :accounting_insurance_account_number, 
                  :accounting_supply_account_number, :accounting_payment_cash_account_number, :accounting_payment_debit_account_number, 
                  :accounting_payment_credit_account_number, :accounting_payment_cheque_account_number
